...
const PullQuote = () => (
  <section className="bg-surface-container-low py-40 relative overflow-hidden">
    ...
    <div className="max-w-4xl mx-auto text-center px-8 relative z-10">
      <Quote className="text-secondary mx-auto mb-12 drop-shadow-md" size={64} strokeWidth={1} />
      <blockquote className="font-headline italic text-5xl lg:text-7xl text-primary leading-[1.1] mb-12 mix-blend-multiply">
        "Quando uma mulher se transforma, ela move o mundo ao seu redor."
      </blockquote>
      <cite className="font-label uppercase tracking-[0.4em] text-[12px] text-secondary not-italic font-bold">— Manifesto Entre Elas</cite>
    </div>
  </section>
);
